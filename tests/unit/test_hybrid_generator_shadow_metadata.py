...
@pytest.mark.asyncio
async def test_hybrid_generator_propagates_shadow_metadata(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from nlp2cmd.generation.hybrid import HybridGenerator

    pipeline = RuleBasedPipeline()
    generator = HybridGenerator(rule_pipeline=pipeline, llm_generator=None, confidence_threshold=0.0)
