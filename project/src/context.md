...
- **Calls**: entities.get, self.APP_COMMANDS.get, nlp2cmd.automation.complex_planner._debug, actions.append, self._detect_followup_actions, actions.extend, self._extract_app_name, app_name.lower
...
- **Calls**: str, nlp2cmd.automation.complex_planner._debug, isinstance, nlp2cmd.automation.complex_planner._debug, self._has_fill_form_action, self._should_explore_for_forms, self._should_explore_for_content, self._has_type_action
...
- **Calls**: time.perf_counter, self._resolve_platform_url, self._try_github_api, nlp2cmd.executor.ExecutionContext.set, self._explore_recursive, nlp2cmd.automation.complex_planner._debug, self._find_best_content_candidate, ExplorationResult
