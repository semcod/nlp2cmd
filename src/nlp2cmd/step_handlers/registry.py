...
def _register_default_handlers(registry_cls: type[HandlerRegistry]) -> None:
    ...
    registry_cls._handlers.update({
        ...
        "draw_ellipse": DrawEllipseHandler,
        "draw_arc": DrawArcHandler,
        "draw_polygon": DrawPolygonHandler,
        "draw_bezier": DrawBezierHandler,
        "draw_svg_path": DrawSvgPathHandler,
        "fill_at": FillAtHandler,
        "click_canvas": ClickCanvasHandler,
        "draw_line": DrawLineHandler,
        "extract_key": ExtractKeyHandler,
        "extract_api_key": ExtractApiKeyHandler,
