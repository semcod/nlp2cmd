"""
Interactive REPL session for NLP2CMD CLI.

Contains the InteractiveSession class and related helpers.
"""
...
class InteractiveSession:
    ...
    def display_feedback(self, feedback, include_explanation: bool = False):
    ...
    def run(self):
        ...
        from nlp2cmd.feedback import FeedbackType
...
[bold]Examples:[/bold]
  ...
  Scale deployment nginx to 5 replicas
    ...
    def _correction_loop(self, feedback):
        """Interactive correction loop."""
        from nlp2cmd.feedback import FeedbackType
...
def _interactive_followup(session: InteractiveSession, feedback) -> Any:
