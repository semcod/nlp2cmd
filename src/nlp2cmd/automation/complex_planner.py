...
DRAWING_PATTERNS: list[dict[str, Any]] = [
    {
        ...
        "description": "Draw a ladybug (red circle with black dots)",
        "steps": [
            ...
            ActionStep("select_tool", {"tool": "brush"}, "Select brush tool"),
            ActionStep("set_color", {"color": "#000000"}, "Set color to black"),
            ActionStep("draw_circle", {"radius": 12, "offset": (-40, -30)},
                       "Draw dot 1 (left-top)"),
            ActionStep("draw_circle", {"radius": 12, "offset": (40, -30)},
                       "Draw dot 2 (right-top)"),
            ActionStep("draw_circle", {"radius": 12, "offset": (0, 20)},
                       "Draw dot 3 (center)"),
            ActionStep("draw_circle", {"radius": 10, "offset": (-25, 45)},
                       "Draw dot 4 (left-bottom)"),
            ActionStep("draw_circle", {"radius": 10, "offset": (25, 45)},
                       "Draw dot 5 (right-bottom)"),
            ActionStep("draw_circle", {"radius": 8, "offset": (0, -60)},
                       "Draw dot 6 (top)"),
